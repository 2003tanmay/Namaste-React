...
/********************** one of the way for adding dynamic data */

// // const RestaurentCard = ({resName, cuisine, rating, time}) destructring the data
// const RestaurentCard = (props) => {
//   //recieving arguments
//   // const { resName, cuisine } = props; one more way for destructring of data
//   return (
//     <div className="res-card">
//       <div className="card-image">
//         <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHu-vEn4T3y8SSfgMjXyP64CZl8DXjSt5yhw&s" />
//       </div>
//       <h3>{props.resName}</h3> {/* using props */}
//       {/* <h3>{props.resName}</h3> after destructring we now directly use properties */}
//       <h4>{props.cuisine}</h4>
...
//         {/* <RestaurentCard /> Instead of hard coding of res. we now achieve dynamic res. using props
//         <RestaurentCard />
//         <RestaurentCard /> */}
...
/******************* Now we use real api data to make our app dynamic */
